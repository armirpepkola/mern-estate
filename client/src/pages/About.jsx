  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center py-20 px-4 max-w-6xl mx-auto'>
        <h1 className='text-4xl font-bold mb-6 text-teal-500 text-center'>About Albanian Realty Marketplace</h1>
      ...
      <div className="px-96 mb-20">
        <div className="mockup-code">
          <pre data-prefix="$"><code>npm i RealEstate Marketplace</code></pre> 
